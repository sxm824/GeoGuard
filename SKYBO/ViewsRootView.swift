...
struct RootView: View {
    ...
    private func roleBasedView(for user: User) -> some View {
        ...
        let _ = print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
        let _ = print("🔵 RootView - Role Detection Debug")
        let _ = print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
        let _ = print("👤 User: \(user.fullName)")
        let _ = print("📧 Email: \(user.email)")
        let _ = print("🏢 Tenant: \(user.tenantId)")
        let _ = print("📋 All Roles: \(user.roles.map { $0.rawValue })")
        let _ = print("⭐ Primary Role: \(user.primaryRole.rawValue)")
        ...
        let _ = print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
        let _ = print("🔍 Role Check Results:")
        let _ = print("   Has Admin Role? \(hasAdminRole)")
        let _ = print("   Has Field Role? \(hasFieldRole)")
        let _ = print("   Should Show Dual Dashboard? \(hasAdminRole && hasFieldRole)")
        let _ = print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
        
        if hasAdminRole && hasFieldRole {
            // DUAL ROLE: Show tabbed interface with both dashboards
            let _ = print("✅ Routing to: DualRoleDashboardView (Admin + Field Personnel)")
            let _ = print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n")
            DualRoleDashboardView()
                .transition(.opacity)
        } else {
            // SINGLE ROLE: Show appropriate dashboard based on primary role
            let _ = print("✅ Routing to: \(user.primaryRole.rawValue) Dashboard (Single Role)")
            let _ = print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n")
